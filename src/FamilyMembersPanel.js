              ...
              <tr key={member.id} className="border-t">
                ...
                <td className="py-2 px-3">
                  <input 
                    ...
                    min={currentYear}
                    onChange={(e) => updateFamilyMember(member.id, 'graduationYear', parseInt(e.target.value))}
                  ...
                  <div className="flex flex-wrap gap-2">
                    <label className="inline-flex items-center">
                      <input 
                        ...
                        onChange={(e) => updateFamilyMember(member.id, 'includeOptionalCosts.lunch', e.target.checked)}
                    ...
                    <label className="inline-flex items-center">
                      <input 
                        ...
                        onChange={(e) => updateFamilyMember(member.id, 'includeOptionalCosts.transport', e.target.checked)}
                    ...
                    <label className="inline-flex items-center">
                      <input 
                        ...
                        onChange={(e) => updateFamilyMember(member.id, 'includeOptionalCosts.uniform', e.target.checked)}
                    ...
                    <label className="inline-flex items-center">
                      <input 
                        ...
                        onChange={(e) => updateFamilyMember(member.id, 'includeOptionalCosts.afterSchool', e.target.checked)}
