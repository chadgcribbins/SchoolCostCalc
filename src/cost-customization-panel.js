                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input 
                      ...
                      onChange={(e) => updateCustomSchoolData(schoolId, 'baseTuition', e.target.value)}
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      onChange={(e) => updateCustomSchoolData(schoolId, 'registrationFee', e.target.value)}
                      className="border rounded p-1 w-full"
                    />
                  </div>
                  <div>
                    ...
                    <input 
                      ...
                      onChange={(e) => updateCustomSchoolData(schoolId, 'yearlyEnrollmentFee', e.target.value)}
                      className="border rounded p-1 w-full"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      onChange={(e) => updateCustomSchoolData(schoolId, 'afterSchool', e.target.value)}
                      className="border rounded p-1 w-full"
                    />
                  </div>
