    ...
    Object.keys(schoolsData).forEach(schoolId => {
      ...
      familyMembers.forEach((member, index) => {
        ...
        Object.keys(memberCosts.yearly).forEach(year => {
          ...
          schoolCosts.yearly[year].breakdown.baseTuition +=
            memberCosts.yearly[year].breakdown.baseTuition;
          schoolCosts.yearly[year].breakdown.yearlyEnrollmentFee +=
            memberCosts.yearly[year].breakdown.yearlyEnrollmentFee;
          schoolCosts.yearly[year].breakdown.lunch += memberCosts.yearly[year].breakdown.lunch;
          schoolCosts.yearly[year].breakdown.transport +=
            memberCosts.yearly[year].breakdown.transport;
          schoolCosts.yearly[year].breakdown.uniform += memberCosts.yearly[year].breakdown.uniform;
          schoolCosts.yearly[year].breakdown.afterSchool +=
            memberCosts.yearly[year].breakdown.afterSchool;
        });
      });
